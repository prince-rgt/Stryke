  ...
  [5009],
  {
    ...
    27267: (e, t, a) => {
      ...
      function n(e, t, a, n, o) {
        function r(o) {
          ...
          const r = o.target;
          void 0 !== a && null !== t && null !== r && r.ownerDocument === n && (t.contains(r) || a(o));
        }
        return (
    ...
    69654: (e, t, a) => {
      ...
      function u(e) {
        ...
        return n.createElement(
          ...
          u && n.createElement('div', { className: c.cancel, onClick: u }, i.t(null, void 0, a(20036))),
        );
      }
      function m(e) {
        const {
    ...
    76068: (e, t, a) => {
      ...
      function r(e) {
        ...
        const r = (0, o.getStyleClasses)(e.size, e.className),
          i = null !== (a = null !== (t = e.alt) && void 0 !== t ? t : e.title) && void 0 !== a ? a : '';
    ...
    19785: (e, t, a) => {
          ...
          .map((e) => {
            ...
            return (
              a.forEach((e) => {
                ...
                if (((h.lastIndex = 0), (0, n.isString)(t) && t && t.toLowerCase() === o.toLowerCase()))
                  return (d = 4), void (m = null === (a = t.match(g)) || void 0 === a ? void 0 : a.index);
                if ((0, n.isString)(t) && g.test(t))
                  return (d = 3), void (m = null === (i = t.match(g)) || void 0 === i ? void 0 : i.index);
                if ((0, n.isString)(r) && g.test(r))
                  return (d = 2), void (m = null === (l = r.match(g)) || void 0 === l ? void 0 : l.index);
                if ((0, n.isString)(r) && h.test(r))
                  return (d = 2), void (m = null === (s = r.match(h)) || void 0 === s ? void 0 : s.index);
                if (Array.isArray(u))
                  for (const e of u)
                    if (g.test(e))
                      return (d = 1), void (m = null === (c = e.match(g)) || void 0 === c ? void 0 : c.index);
              }),
      ...
      function r(e, t) {
        ...
        return (
          ...
          t && t.hasOwnProperty(n) && a.push({ fullMatch: t[n], re: t[n], fuzzyHighlight: !1 }),
          a
        );
      }
      function i(e, t, a) {
                ...
                if (e.fuzzyHighlight) {
                  ...
                  for (let t = 1; t < l.length; t++) {
                    const a = l[t],
                      o = l[t].length;
                    if (t % 2) {
                      const t = a.startsWith(' ') || a.startsWith('/') || a.startsWith('-');
                      n[t ? e + 1 : e] = !0;
                    }
                    e += o;
                  }
    ...
    24637: (e, t, a) => {
      ...
      function l(e) {
        const { queryString: t, rules: a, text: l, className: s } = e,
          c = (0, n.useMemo)(() => (0, r.getHighlightedChars)(t, l, a), [t, a, l]);
        return n.createElement(
          n.Fragment,
          null,
          c.length
            ? l
                ...
                .map((e, t) =>
                  n.createElement(
                    ...
                    { key: t },
                    c[t]
                      ? n.createElement('span', { className: o(i.highlighted, s) }, e)
      ...
      function d(e) {
        ...
        return n.createElement(
          Y,
          {
            ...
            onClick: function (t) {
              const { dontClosePopup: a, onClick: n, onClickArg: o, trackEventObject: l } = e;
              if (w) return;
          ...
          (void 0 !== v || _) &&
            n.createElement('span', { className: R.shortcut }, (J = v) && J.split('+').join(' + ')),
          void 0 !== M &&
            n.createElement(
              'span',
              {
    ...
    34557: (e, t, a) => {
      ...
      var M = a(3085),
        z = a(46188);
      function T(e) {
        const { className: t, onScroll: a, onTouchStart: o, reference: r, children: l, scrollbar: s, ...c } = e,
      ...
      function ne(e) {
        const { charts: t, onClose: o, favoriteChartsService: r, chartWidgetCollection: d } = e,
          ...
          [S, x] = (0, n.useState)(() => c.getJSON('loadChartDialog.viewState', Q)),
          A = (0, n.useRef)(null),
          N = (0, n.useRef)(null),
          M = (0, n.useMemo)(
            () =>
        ...
        const F = (0, n.useCallback)(() => !0, []),
          ...
          }, [h, S, p, k]),
          {
            ...
            return (
              (0, n.useEffect)(() => {
                var e;
                -1 !== o && (null === (e = a.current) || void 0 === e || e.scrollToItem(o));
              }, [o]),
              {
                selectedItemIndex: o,
                setSelectedItemIndex: r,
