  ...
  [4862],
  {
    ...
    67029: (e, t, n) => {
      ...
      function v(e, t) {
        const {
          ...
          { isGrouped: k, cellState: M, disablePositionAdjustment: D = !1 } = (0, o.useContext)(a.ControlGroupContext),
    ...
    23263: (e, t, n) => {
      ...
      const E = o.forwardRef((e, t) => {
        const { tabs: n, size: r = 'xsmall', variant: i = 'primary', theme: s = I() } = e;
        return o.createElement(
          'div',
      ...
      const L = new l.TranslatedString('remove all line tools for {symbol}', s.t(null, void 0, n(23481))),
        z = (e) =>
    ...
    67165: (e, t, n) => {
      ...
      function P(e) {
        ...
        return o.createElement(
          o.Fragment,
          null,
          !t && o.createElement('div', { className: I(A.title, A.withoutIcon) }, v.t(null, void 0, n(31095)), h),
          o.createElement(
            'div',
            { className: A.buttons },
      ...
      function* Xe(e) {
        ...
        !Ge(yield (0, S.select)()) && t.length > 0 && (yield (0, S.put)(Ie(t[0])), yield (0, S.put)(Ee(t[0])));
      }
      function* et(e) {
        for (;;) {
      ...
      function* rt(e = () => !0, t) {
        ...
        u.map((e) => e.id).includes(d.id)
          ...
          : h &&
            e(u, d, o) &&
            (yield (0, S.put)(((e, t, n) => ({ type: re, node: e, dropType: t, boundBox: n }))(d, o, i)));
      }
      function* it(e) {
      ...
      function at(e, t, n, o) {
        ...
        -1 === o && 'previous' === t && (o = r);
        let s = 0;
        for (; !i || (Math.abs(s) < r && (l = i).level > 1 && !Fe(e, (0, T.ensureDefined)(l.parentId))); )
      ...
      function* ct(e = {}) {
        const {
          ...
          c = [(0, S.fork)(it, o), (0, S.fork)(st, n), (0, S.fork)(ot, i, a), (0, S.fork)(nt, i, s), (0, S.fork)(tt)];
      ...
      const Dt = (e) => {
          ...
          return (
            (bt.CheckMobile.any() || bt.CheckMobile.isIPad()) && ((S = n), (w = { onMouseOut: kt, onMouseOver: kt })),
            o.createElement(
              'div',
              {
                className: I(Et.wrap, n && Et.selected, f && Et.childOfSelected, l && Et.disabled, i && Et.expandable),
                onClick:
                  1 === v && 0 === b
                    ? T
                    : function (e) {
      ...
      const un = o.memo(function (e) {
        ...
        return (
          (0, o.useEffect)(() => {
            var e;
            t.dispatch(Ee(null !== (e = null == n ? void 0 : n.id) && void 0 !== e ? e : null));
          }, [n]),
          o.createElement(
            V.DndProvider,
      ...
      function Kn(e) {
        ...
        const V = kn.enabled('test_show_object_tree_debug') ? `<${u.id()}> (${u.zOrder()}) ${u.title()}` : u.title(),
          G = a || O,
          U = f && s,
          Z = !!p && p.isTouch,
          K = !!p && p.isDialog,
                  ...
                  : function (e) {
                      ...
                      if (W.current)
                        ...
                        W.current = setTimeout(() => {
                          (W.current = null), s && !B && 1 === e.length && g.rename(u, () => b(!0)), F(!1);
                        }, 500);
                      }
                    },
            ...
            !U &&
              o.createElement(
                ...
                o.createElement(
                  'span',
                  {
                    className: I(Un.title, g.isMain(u) && Un.main, (!u.isVisible() || !z) && Un.disabled),
                    ...H,
                  },
                  V,
                ),
      ...
      class oo {
        constructor(e) {
          (this._onChange = new Xn.Delegate()),
            (this._recalculate = () => {
              const e = this._groupModel.groups().map((e) => to(e.id, e.instanceId())),
      ...
      var so = n(36298),
        ...
        fo = n(57674),
        vo = n(37591);
      const bo = new so.TranslatedString('show {title}', v.t(null, void 0, n(87358))),
        yo = new so.TranslatedString('hide {title}', v.t(null, void 0, n(70301))),
        _o = new so.TranslatedString('lock {title}', v.t(null, void 0, n(50193))),
        So = new so.TranslatedString('unlock {title}', v.t(null, void 0, n(92421))),
        wo = new so.TranslatedString('change {sourceTitle} title to {newSourceTitle}', v.t(null, void 0, n(40001))),
        Co = new so.TranslatedString('insert source(s) after', v.t(null, void 0, n(8343))),
        To = !1;
      function Io(e, t) {
        return t.every((t) => !(t.pane() !== e && !t.allowsMovingbetweenPanes()));
      }
      function Eo(e) {
        return e instanceof co.DataSource && e.showInObjectTree() ? to(e.id(), e.instanceId()) : null;
      }
      function ko(e) {
        return new so.TranslatedString(e.name(), e.title(vo.TitleDisplayTarget.DataWindow));
      }
      ...
      class Do {
        constructor(e, t) {
          ...
          null !== n && n === t && n.isSynchronizable() && go.isToolCreatingNow.subscribe(this._updateSyncState);
        }
        destroy() {
          (0, lo.isLineTool)(this._dataSource) &&
        ...
        canBeLocked() {
          return (0, lo.isLineTool)(this._dataSource) && this._dataSource.userEditEnabled();
        }
        canBeRemoved() {
        ...
        isActualInterval() {
          return (
            (!(0, lo.isLineTool)(this._dataSource) && !(0, ao.isStudy)(this._dataSource)) ||
            this._dataSource.isActualInterval()
          );
        }
        onIsActualIntervalChange() {
          return (0, lo.isLineTool)(this._dataSource) || (0, ao.isStudy)(this._dataSource)
            ? this._dataSource.onIsActualIntervalChange()
            : Mo;
        }
        isLocked() {
          return !!(0, lo.isLineTool)(this._dataSource) && this._dataSource.properties().frozen.value();
        }
        onVisibilityChanged() {
          return this._dataSource.properties().visible.listeners();
        }
        onLockChanged() {
          return (0, lo.isLineTool)(this._dataSource) ? this._dataSource.properties().frozen.listeners() : Mo;
        }
        getIcon() {
          const e = c,
          ...
          if (e && t)
            ...
            } else 'svgContent' === t.type && (o = { type: En.Svg, content: t.content });
          return o;
        }
        onIconChanged() {
        ...
        setName(e) {
          if ((0, lo.isLineTool)(this._dataSource)) {
            ...
            this._undoModel.setProperty(this._dataSource.properties().title, e, t, To);
          }
        }
        isCopiable() {
        ...
        canBeAddedToGroup() {
          return (0, lo.isLineTool)(this._dataSource) && this._dataSource.boundToSymbol();
        }
        ...
        canBeSyncedInLayout() {
          return (0, lo.isLineTool)(this._dataSource) && this._dataSource.isSynchronizable();
        }
        onSyncStateChanged() {
          ...
          if ((0, lo.isLineTool)(this._dataSource)) {
            ...
            null !== t
              ? ((0, T.assert)(!e.some((e) => e.hasChildren())),
                i.forEach((e) => {
                  (0, lo.isLineTool)(e) && (t.containsLineTool(e) || o.addLineToolToGroup(t, e));
                }))
              : r();
          } else r();
      ...
      class No {
        ...
        childrenIds() {
          ...
          return e.sort((e, t) => t.zorder() - e.zorder()), new Set(e.map((e) => to(e.id(), e.instanceId())));
        }
        hasChildren() {
          return !0;
        }
      ...
      class xo {
        ...
        canBeGroupped(e) {
          ...
          const t = [];
          if ((e.forEach((e) => e.addSourcesToArray(t)), t.some((e) => !(0, lo.isLineTool)(e) || !e.boundToSymbol())))
            return !1;
          const n = this._undoModel.model(),
      ...
      const Vo = new so.TranslatedString('move objects', v.t(null, void 0, n(40566))),
        Go = new so.TranslatedString('lock objects', v.t(null, void 0, n(68163))),
        Uo = new so.TranslatedString('unlock objects', v.t(null, void 0, n(66824))),
        Zo = new so.TranslatedString('show objects', v.t(null, void 0, n(63549))),
        Ko = new so.TranslatedString('hide objects', v.t(null, void 0, n(28506))),
        Yo = new so.TranslatedString('remove objects', v.t(null, void 0, n(57428)));
      class $o {
        constructor(e) {
          (this._nodes = {}),
            (this._onChange = new Xn.Delegate()),
        ...
        canSelectionBeUnmerged() {
          const e = this._getSelectedEntities();
          return 1 === e.length && this.canNodeWithIdBeUnmerged(no(e[0].id()).persistentId);
        }
        canNodeWithIdBeUnmerged(e) {
          const t = this._model.dataSourceForId(e);
          return null !== t && (0, Lo.isPriceDataSource)(t) && this._model.isUnmergeAvailableForSource(t);
        }
        unmergeSelectionUp() {
        ...
        copySelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) => (0, T.ensureNotNull)(this._model.dataSourceForId(no(e.id()).persistentId)));
          this._chart.value().chartWidgetCollection().clipboard.uiRequestCopy(t), dn('Copy', hn(e));
        }
        cloneSelection() {
          const e = this._getSelectedEntities(),
            t = e.map((e) => (0, T.ensureNotNull)(this._model.dataSourceForId(no(e.id()).persistentId)));
          t.every(lo.isLineTool) && (this._controller.cloneLineTools([...t], !1), dn('Clone', hn(e)));
        }
        rename(e, t) {
        ...
        async openContextMenu(e, t, n) {
          ...
          if (i.length > 0) {
            ...
            (a = s
              ...
              zo.ContextMenuManager.showMenu(i, n, { takeFocus: !0, returnFocus: !0 }, a, () => {
        ...
        _getActionsForGroupItem(e, t, n) {
          ...
          const r = [];
          1 === this._objects.length && r.unshift(this._getRenameAction(t), new jo.Separator()),
            n && r.unshift(this._getGroupAction(), new jo.Separator());
          const i = (0, ho.createSyncDrawingActions)(this._chart.value(), o.filter(lo.isLineTool));
        ...
        _unmergeSelection(e) {
          ...
          const n = t[0],
            o = (0, T.ensureNotNull)(this._model.dataSourceForId(no(n.id()).persistentId));
          if (!(0, Lo.isPriceDataSource)(o)) throw new Error('Entity is not IPriceDataSource');
        ...
        _getSelectedEntities() {
          ...
          return (
            t.length &&
              Ho.logWarn(`Detected dangling sources in selection. They will be ignored: ${JSON.stringify(t)}`),
            e
          );
        }
        _getEntityById(e) {
