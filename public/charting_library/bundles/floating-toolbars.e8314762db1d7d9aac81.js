  ...
  [2306],
  {
    ...
    70114: (t, e, o) => {
      ...
      var i = o(50959),
        ...
        m = o(12005);
      function v(t) {
        const { property: e, icon: o, propertyApplier: n, title: v, undoText: y, isToolbarFixed: w, className: b } = t,
          f = (0, g.useProperty)(e),
          C = (0, i.useRef)(null),
        ...
        return i.createElement(
          ...
          {
            className: b,
            verticalDropDirection: w ? _.VerticalDropDirection.FromBottomToTop : void 0,
            horizontalDropDirection: w ? _.HorizontalDropDirection.FromLeftToRight : void 0,
        ...
        return i.createElement(
          a.ToolWidgetMenu,
          {
            ...
            content: i.createElement(
              ...
              null,
              f
                ? i.createElement('div', { className: v.multiWidth }, i.createElement(s.Icon, { icon: m }))
                : i.createElement(
                    'div',
          ...
          return i.createElement(
            ...
            i.createElement(
              ...
              i.createElement(
                ...
                i.createElement(w.Button, { size: 's', onClick: this._handleAddColor }, W),
              ),
            ),
            i.createElement(
              'div',
        ...
        _createLinetoolWidget(t) {
          ...
          return (
            o.addEventListener('click', async (e) => {
              e.preventDefault(), await (0, _.initLineTool)(t), d.tool.value() !== t && d.tool.setValue(t);
            }),
        ...
        _initSortable() {
          ...
          lazyJqueryUI(this._content).sortable({
            ...
            stop: (e, o) => {
              ...
              t !== i && ((0, y.trackEvent)('Floating Toolbar', 'User Sort'), this._reorderedDelegate.fire(t, i));
            },
            tolerance: 'pointer',
            distance: 5,
    ...
    89824: (t, e, o) => {
      ...
      function I(t) {
        ...
        const a = s[0].properties().frozen,
          l = (0, W.useProperty)(a),
          c = l ? { title: r.t(null, void 0, o(15101)), icon: k } : { title: r.t(null, void 0, o(42284)), icon: N };
      ...
      const ut = !1,
        ...
        _t = new s.TranslatedString('change line tool(s) line style', r.t(null, void 0, o(54769))),
        mt =
        ...
        _createProperty(t, e, o, i) {
          if (e) {
            ...
            return this._isWidthProperty(t[0])
              ? new _(new h.MultipleLineWidthsProperty(t), this._propertyApplierImpl(), i)
          ...
          if (t && t.visible())
            return this._isWidthProperty(t)
              ...
              : new m.CollectibleColorPropertyDirectWrapper(new h.MultipleLineColorsProperty([t]));
        }
