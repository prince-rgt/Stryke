(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [3291],
  {
    ...
    81261: (e, t, n) => {
      ...
      const i = [37, 39, 38, 40];
      function u(e, t) {
        e.target && r.PLATFORM_ACCESSIBILITY_ENABLED && e.relatedTarget === t.current && s(e.target);
      }
      function c(e) {
        ...
        switch (t) {
          case 37:
            if (!m.length) return;
            e.preventDefault(), h(0 === v ? u[s] : y ? l(m, v, -1) : m[m.length - 1]);
            break;
          case 39:
            if (!m.length) return;
            e.preventDefault(), v === m.length - 1 ? h(u[s]) : h(y ? l(m, v, 1) : m[0]);
            break;
          case 38: {
            e.preventDefault();
            const t = l(u, s, -1);
    ...
    50298: (e, t, n) => {
      ...
      const l = (0, r.forwardRef)(function (e, t) {
        const { tooltip: n, menuReference: l = null, ...f } = e,
          [d, p] = (0, i.useRovingTabindexElement)(null),
          m = (0, o.useFunctionalRefObject)(l);
        return (
          ...
          r.createElement(a.ToolWidgetMenu, {
            ...
            onMenuFocus: (e) => (0, s.handleAccessibleMenuFocus)(e, d),
          })
        );
      });
    },
