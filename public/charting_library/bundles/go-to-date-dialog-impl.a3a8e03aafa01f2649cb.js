      ...
      class z extends r.PureComponent {
        ...
        render() {
          const {
            ...
            K = 'after' !== y ? _ : void 0,
            Q = 'after' === y ? _ : void 0,
            G = 'string' == typeof o ? o : W || '',
            V = (0, k.filterDataProps)(this.props),
            Z = (0, D.mergeRefs)([this._handleReference, j]);
          return r.createElement(m.MatchMedia, { rule: h.DialogBreakpoints.SmallHeight }, (y) =>
            r.createElement(m.MatchMedia, { rule: h.DialogBreakpoints.TabletSmall }, (h) =>
              r.createElement(
                ...
                {
                  rounded: !(h || C) && w,
                  className: s()(M.dialog, C && J && M.bounded, e),
                  isOpened: n,
                  reference: Z,
                  ...
                  containerAriaLabel: F,
                  containerTabIndex: H,
                  calculateDialogPosition: C && J ? this._calculatePositionWithOffsets : void 0,
                  shadowed: R,
                  ...V,
                },
                r.createElement(
                  ...
                  r.createElement(p.PopupContext.Consumer, null, (e) => this._renderChildren(e, h || C)),
                ),
              ),
            ),
          );
