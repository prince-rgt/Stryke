      ...
      class N extends o.PureComponent {
        ...
        render() {
          const {
            ...
            Y = 'after' !== f ? b : void 0,
            Z = 'after' === f ? b : void 0,
            j = 'string' == typeof r ? r : K || '',
            X = (0, w.filterDataProps)(this.props),
            q = (0, x.mergeRefs)([this._handleReference, F]);
          return o.createElement(h.MatchMedia, { rule: p.DialogBreakpoints.SmallHeight }, (f) =>
            o.createElement(h.MatchMedia, { rule: p.DialogBreakpoints.TabletSmall }, (p) =>
              o.createElement(
                ...
                {
                  rounded: !(p || I) && S,
                  className: i()(O.dialog, I && G && O.bounded, e),
                  isOpened: l,
                  reference: q,
                  ...
                  containerAriaLabel: R,
                  containerTabIndex: W,
                  calculateDialogPosition: I && G ? this._calculatePositionWithOffsets : void 0,
                  shadowed: V,
                  ...X,
                },
                o.createElement(
                  ...
                  o.createElement(m.PopupContext.Consumer, null, (e) => this._renderChildren(e, p || I)),
                ),
              ),
            ),
          );
    ...
    59054: (e, t, n) => {
      ...
      const b = o.forwardRef((e, t) => {
        const {
          ...
          M = (0, o.useRef)(null),
          B = !p && o.createElement(s.EndSlot, null, o.createElement(m, { isDropped: g, disabled: v, className: S }));
    ...
    90405: (e, t, n) => {
      ...
      const C = o.forwardRef((e, t) => {
        ...
        const {
          ...
          ae = (0, l.joinDomIds)(T, n),
          se = ae.length > 0 ? ae : void 0,
          de = (0, o.useMemo)(
            () => ({
              role: 'listbox',
              'aria-labelledby': T,
