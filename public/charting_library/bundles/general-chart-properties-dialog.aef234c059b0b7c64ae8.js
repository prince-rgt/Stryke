    ...
    50366: (e, t, a) => {
      ...
      function h(e) {
        ...
        return i.createElement(
          ...
          {
            ...h,
            className: l()(c.tab, p && c.isTablet, u && c.isMobile, m && c.active),
            onClick: d,
          },
            ...
            (this._handleSaveAs = () => {
              if (P) {
                ...
                window.runOrSignIn(
                  () =>
                    (async function (e, t) {
                      const [i, n] = await Promise.all([a.e(7648).then(a.bind(a, 57351)), (0, k.getThemeNames)()]);
        ...
        show(e) {
          l.render(
            ...
            Z.emit('edit_object_dialog', {
              ...
              scriptTitle: this._model.mainSeries().title(J.TitleDisplayTarget.StatusLine),
            });
        }
        _ensureCheckpoint(e) {
