  ...
  [5901],
  {
    ...
    2568: (e, t, n) => {
      ...
      const g = s.forwardRef((e, t) => {
        ...
        return s.createElement(d.ControlSkeleton, {
          ...
          ...(W && {
            endSlot: s.createElement('span', { className: r(!A && v()['with-icon']) }, W),
          }),
        });
      });
      ...
      const b = (e, t, n) => (t ? void 0 : e ? -1 : n),
        ...
        C = s.forwardRef((e, t) => {
          ...
          return s.createElement(g, {
            ...
            containerReference: (0, a.useMergedRefs)([S, I]),
            hasIcon: _,
          });
        });
    ...
    92399: (e, t, n) => {
      ...
      function m(e) {
        const {
          ...
          w = b && void 0 !== a ? [a] : void 0,
          x = r(p.inputContainer, d[u], t),
          _ = f ? o.createElement(i.StartSlot, { className: p.innerLabel, interactive: !1 }, f) : void 0,
    ...
    58593: (e, t, n) => {
      ...
      function d(e) {
        ...
        function E(e) {
          if (27 === (0, i.hashFromEvent)(e)) g && (e.preventDefault(), S());
        }
        function S() {
          b(!1), (0, a.ensureNotNull)(y.current).focus(), r && r();
        }
      }
      var h = n(56512),
        m = n(87095),
        ...
        class extends o.PureComponent {
          ...
          render() {
            const { name: e, checked: t, value: n } = this.props,
              r = s(f.thicknessItem, { [f.checked]: t }),
              a = s(f.bar, { [f.checked]: t }),
      ...
      var E = n(86536);
      const S = g.t(null, void 0, n(60142));
      function w(e) {
                ...
                o.createElement(
                  ...
                  a && 'mixed' !== a
                    ...
                    : o.createElement(
                        ...
                        o.createElement('div', {
                          className: 'mixed' === a ? x.mixedColor : x.placeholder,
                        }),
                      ),
                  s &&
                    (function () {
    ...
    48897: (e, t, n) => {
      ...
      function x(e) {
        ...
        return o.createElement(b, {
          ...
          disabled: i,
          className: r()(p, u.enabled('uppercase_instrument_names') && w.uppercase),
        });
      }
      function _(e) {
        if ('definition' in e) {
    ...
    1861: (e, t, n) => {
      ...
      function l(e) {
        ...
        function B() {
          s.unmountComponentAtNode(k), a.dialogsOpenerManager.setAsClosed('SymbolSearch'), C && C();
        }
        return s.render(P, k), a.dialogsOpenerManager.setAsOpened('SymbolSearch'), y && y(), { close: B };
      }
    },
    73146: (e, t, n) => {
      'use strict';
    ...
    31356: (e, t, n) => {
      ...
      function a(e) {
        ...
        return o.createElement(
          ...
          Boolean(c) &&
            o.createElement(s.PropertyTable.Cell, { placement: 'last', 'data-section-name': t }, c, u && !1),
        );
      }
    },
    86067: (e, t, n) => {
    ...
    59054: (e, t, n) => {
      ...
      const g = o.forwardRef((e, t) => {
        const {
          ...
          V = (0, o.useRef)(null),
          O = !d && o.createElement(l.EndSlot, null, o.createElement(m, { isDropped: f, disabled: b, className: B }));
    ...
    90405: (e, t, n) => {
      ...
      const C = o.forwardRef((e, t) => {
        ...
        const {
          ...
          me = (0, p.useKeyboardClose)(q, Y),
          ve = (0, p.useKeyboardOpen)(q, K),
          ge = (0, p.useKeyboardEventHandler)([he, me, ve]),
          be = (0, p.useKeyboardEventHandler)([de, he, me]),
          fe = (function (e) {
            const t = (0, o.useRef)(''),
              n = (0, o.useMemo)(
                () =>
        ...
        return o.createElement(
          d.ControlDisclosureView,
          {
            ...
            onListboxKeyDown: function (e) {
              be(e), e.defaultPrevented || fe(e);
            },
            buttonChildren: o.createElement(f, {
              selectedItem: oe,
              placeholder: _,
            }),
    ...
    39847: (e, t, n) => {
      ...
      var c = n(38952),
        ...
        v = n(78370),
        g = n.n(v);
      const b = { info: d, question: p, check: h, exclamation: m };
      function f(e) {
        return o.createElement('span', {
          ...(0, c.renameRef)(e),
      ...
      function C(e) {
        const {
          ...
          I = o.useMemo(
            () =>
              (function (e, t) {
                return t ? b[t] : 'success' === e ? b.check : b.exclamation;
              })(n, t),
            [t, n],
          );
        return o.createElement(
    ...
    12949: (e, t, n) => {
      ...
      class U extends s.PureComponent {
        ...
        render() {
          const { input: e, value: t, disabled: r, hasTooltip: a } = this.props,
            i = R.Interval.parse(void 0 === t ? e.defval : t),
            l = i.isValid() ? i.value() : t,
            c = W ? W.get().filter((e) => !R.Interval.parse(e).isRange()) : [],
            u = (0, L.mergeResolutions)(A, (0, L.isSecondsEnabled)() ? q : [], c);
          return (
            u.unshift(''),
            s.createElement(P.Select, {
              ...
              items:
                ...
                d.map((e) => ({
                  value: e,
                  content: '' === e ? o.t(null, void 0, n(94551)) : (0, L.getTranslatedResolutionModel)(e).hint,
                }))),
              value: l,
              onChange: this._onChange,
              disabled: r,
      ...
      const Q = (0, h.bind)(function (e) {
        const { value: t, onChange: n, input: o, tzName: r, hasTooltip: a } = e,
          ...
          d = (0, s.useMemo)(() => (0, j.getChartTimezoneOffsetMs)(u, r), [u, r]),
          h = (0, s.useMemo)(() => {
        ...
        render() {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              m && s.createElement(te.IconGroupWrapper, null, p && s.createElement(ee.InputTooltip, { title: p }), !1),
            ),
          );
        }
      }
    ...
    39828: (e, t, n) => {
      ...
      function y(e) {
        const { children: t, input: o, disabled: u, onChange: p, grouped: d, tooltip: h, solutionId: y } = e,
          ...
          { values: S, setValue: w } = (0, r.ensureNotNull)(E),
          x = S[o.id],
          ...
          s.createElement(
              ...
              onChange: function (e) {
                N(e),
                  'main-symbol' === e
                    ...
                    : 'another-symbol' === e && T && (0, g.setter)(w, p)(T, o.id, o.name);
              },
            },
            s.createElement(
              l.PropertyTable.Row,
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                k && s.createElement(f.IconGroupWrapper, null, h && s.createElement(b.InputTooltip, { title: h }), !1),
              ),
            ),
          )
        );
        ...
        render() {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              r && s.createElement(f.IconGroupWrapper, null, n && s.createElement(b.InputTooltip, { title: n }), !1),
            ),
          );
        }
      }
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              a && s.createElement(f.IconGroupWrapper, null, o && s.createElement(b.InputTooltip, { title: o }), !1),
            ),
      ...
      function q(e) {
        ...
        return s.createElement(
          ...
          !1,
          !1,
          c.map((e) => s.createElement(s.Fragment, { key: e.id }, s.createElement(L, { content: e }), !1)),
        );
      }
      function U(e, t) {
        return {
    ...
    95052: (e, t, n) => {
      ...
      class b extends o.PureComponent {
        ...
        static getDerivedStateFromProps(e, t) {
          ...
          return (t.focused && !n) || t.value === o ? null : { value: o, displayValue: f(e, o) };
        }
