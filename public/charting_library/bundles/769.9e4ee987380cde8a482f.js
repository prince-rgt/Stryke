  ...
  [769],
  {
    ...
    47291: (e, t, n) => {
      ...
      const h = r.memo((e) => {
        const { style: t, index: n, data: o } = e,
          a = o[n],
          { size: i, onSelect: c, ItemComponent: u, RowComponent: d = s.EmojisRow } = (0, m.useEnsuredContext)(v);
        return 'title' === a.type
    ...
    38297: (e, t, n) => {
      ...
      function E(e) {
          ...
          (0, r.useLayoutEffect)(() => {
            ...
            const e = (0, i.ensureNotNull)(L.current),
              t = () => {
                ...
                if (0 === t.length || (t[0].parentElement && !b(t[0].parentElement, (0, i.ensureNotNull)(L.current)))) {
                  const n = (function (e) {
                    const t = g(e)
                  ...
                  if (null === n) return;
                  if (((0, d.becomeMainElement)(n), t.length > 0)) for (const e of t) (0, d.becomeSecondaryElement)(e);
                }
              };
            return (
        ...
        const [_, B] = (0, r.useState)((null === (t = j[0]) || void 0 === t ? void 0 : t.relatedTitle) || ''),
          R = (0, r.useCallback)((e) => {
            N.current || B(e);
          }, []);
        return r.createElement(
    ...
    85034: (e, t, n) => {
      ...
      function m(e) {
        ...
        return l.PLATFORM_ACCESSIBILITY_ENABLED
          ...
          : r.createElement('div', { className: a()(s.wrapper, n && s.isActive, m), onClick: d }, i);
        function d() {
          o(t);
        }
      }
