const veDPXAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'enum DPXVotingEscrow.DepositType', name: 'deposit_type', type: 'uint8' },
  ...
  {
    inputs: [{ internalType: 'uint256', name: '_unlock_time', type: 'uint256' }],
