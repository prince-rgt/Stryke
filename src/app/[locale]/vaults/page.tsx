...
import { BTC, Arbitrum } from "../../../assets/images"
            ...
            <div className="w-full flex flex-col p-md">
                ...
                <div className="grid grid-cols-2 divide-x divide-background border border-background bg-secondary my-2">
                    ...
                    <Panel 
                        label="TYPE" 
                        prop={
                            <small className='font-mono underline'>
                                HYBRID
                            </small>
                        }
                        />
                    <Panel
                        label="CONTRACT"
                        prop={
                            <small className='font-mono'>WEEKLY</small>
                        }
                        />
                    </div>
                    <div className="grid-row-2 grid divide-y divide-background">
                ...
                {/* Timeline */}
                <div className='my-4'>
                    <h1 className='font-black text-lg'>Timeline</h1>
                </div>
                
            </div>
            <div className='flex flex-col h-full w-1/3 bg-[#202020] p-3 text-muted-foreground text-center'>
                - SideNav -
            </div>
        </div>
    )
