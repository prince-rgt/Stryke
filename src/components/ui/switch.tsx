...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        'pointer-events-none block h-4 w-4 rounded-full bg-subtle shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-3 data-[state=unchecked]:-translate-x-0.5 data-[state=checked]:bg-foreground',
      )}
    />
  </SwitchPrimitives.Root>
));
